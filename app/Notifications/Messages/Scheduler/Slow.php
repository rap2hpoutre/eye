...
class Slow extends BaseMessage
{
    /**
    ...
    {
        return 'A scheduled cron was too slow';
    }
    ...
    {
        return 'The scheduled cron command "'.e($this->meta['scheduler']->command).'" ran too slow and might imply something went wrong';
    }
