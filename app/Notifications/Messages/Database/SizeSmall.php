...
class SizeSmall extends BaseMessage
{
    /**
    ...
    {
        return 'Database size is too small';
    }
    ...
    {
        return 'Warning - the database "'.e($this->meta['connection']).'" size is smaller than your acceptable threshold.';
    }
