...
class FailedCountOk extends BaseMessage
{
    /**
    ...
    {
        return 'Your '.e($this->meta['queue']->connection).' ('.e($this->meta['queue']->tube).') has now resolved its failed jobs';
    }
    ...
    {
        return 'Your queue failed count is now below your set threshold.';
    }
