...
class Offline extends BaseMessage
{
    ...
    {
        return 'Your '.e($this->meta['queue']->connection).' ('.e($this->meta['queue']->tube).') is offline or not responding';
    }
    ...
    {
        return 'Warning - your queue has not had a healthy heartbeat recently. This could be an indication is has become stuck and is not processing jobs.';
    }
