<template>
    <button class="text-white font-bold pr-4 py-2 rounded inline-flex shadow-md items-center" :type="btnType" :class="buttonStatus" @click="pressButton" :disabled="loadingStatus">
...
<script>
    export default {
        ...
        mounted () {
            window.bus.$on('formSubmitting', this.setLoading);
        },
